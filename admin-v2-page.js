(function () {
  ...
  function setupAdmin() {
    ...
    document.addEventListener("click", async event => {
      ...
      if (sendCommissionMessage) {
        const card = sendCommissionMessage.closest(".admin-commission-card");
        const reply = card?.querySelector("[data-commission-message]")?.value || "";
        try {
          await adminData.addCommissionMessage(sendCommissionMessage.dataset.sendCommissionMessage, reply);
          await renderAdmin();
